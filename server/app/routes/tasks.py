...
def get_task_categories():
    return {
        "categories": [
            {"id": "work", "name": "Work", "icon": "fa-briefcase", "color": "#3B82F6"},
            {"id": "fitness", "name": "Fitness", "icon": "fa-dumbbell", "color": "#10B981"},
            {"id": "learning", "name": "Learning", "icon": "fa-book", "color": "#8B5CF6"},
            {"id": "social", "name": "Social", "icon": "fa-users", "color": "#F59E0B"},
            {"id": "personal", "name": "Personal", "icon": "fa-heart", "color": "#EF4444"},
